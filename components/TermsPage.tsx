// components/TermsPage.tsx - Terms & Conditions page component
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            <div className="lg:col-span-8 space-y-4">
              <div className="text-[11px] text-slate-500 flex items-center gap-1">
                ...
                <span className="text-slate-300">{t('breadcrumb.terms')}</span>
              </div>
            ...
            <div className="lg:col-span-4">
              ...
              >
                ...
                <div className="text-[11px] text-slate-400">{summaryCard?.note}</div>
              </motion.div>
            </div>
          </div>
        </HomeSection>
